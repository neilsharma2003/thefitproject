...
/*
let searchQuery = 'weighted dips tricep'.split(' ')

for (let i = 0; i < exercises_db.length; i++) {
    for (let j = 0; j < searchQuery.length; j++) {
        if (exercises_db[i].name.includes(searchQuery[j])) {
            console.log(exercises_db[i])
        }
    }
}
...
for (let i = 0; i < searchQuery.length; i++) {
    for (let j = 0; j < exercises_db.length; j++) {
        if (exercises_db[j].name.includes(searchQuery[i])) {
            console.log(exercises_db[j])
        }
    }
}
*/
